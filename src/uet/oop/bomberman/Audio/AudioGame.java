...
public class AudioGame {
    private static String PATH_EXPLOSION = "/audios/Bom.mp3";
    private static String PATH_BACKGROUND = "/audios/Stage_Theme.mp3";
    ...
    private static String PATH_DEATH = "/audios/Life_Lost.mp3";
